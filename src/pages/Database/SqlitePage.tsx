        ...
        <DocumentationLayout>
            <div className="prose prose-green max-w-none">
                ...
                <h2 className="text-2xl font-semibold mt-10 mb-4 text-gray-800">
                    To use SQLite in Focca Library, follow the steps below:
                </h2>
                ...
                <ul className="mb-6 text-gray-700 leading-relaxed">
                    ...
                    <li>SQLite running</li>
                    <li>sqlite3 package installed</li>
                </ul>
                <Code
                    tabs={[{ label: "NPM", code: "npm install sqlite3" }]}
                />
  ...
  "connections": {
    "sqlite": {
      ...
      "database": "path/to/your/database.sqlite"
                ...
                />
                <p className="mb-6 text-gray-700 leading-relaxed">
                    Note: Replace <code>path/to/your/database.sqlite</code> with the path where you want to store the SQLite database file.
                </p>
                ...
                <Code
                    tabs={[{ label: "Bash", code: "npx focca config:database sqlite" }]}
                />
                <p className="mb-6 text-gray-700 leading-relaxed">
                    This will generate a <code>focca.config.json</code> file with the default settings for SQLite.
                </p>
                ...
                <p className="mb-6 text-gray-700 leading-relaxed">
                    To connect to the SQLite database, you can use the <code>Database</code> class from FOCCA. The default connection will be the one defined in the configuration file.
                </p>
                <Code
                    code={`import { Database } from 'focca';

async function initialize() {
  await Database.getConnection('sqlite');
  ...
  async run() {
    await this.insert([
      ...
      { field1: 'value3', field2: 'value4' },
                ...
                <ul className="mb-6 text-gray-700 leading-relaxed">
                    <li>Ensure that SQLite is accessible and the database path is correct.</li>
                    <li>Check the permissions of the database file.</li>
