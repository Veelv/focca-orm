...
const SqlServerPage = () => {
    return (
        <DocumentationLayout title="FOCCA ORM Documentation for SQL Server">
            <div className="prose prose-green max-w-none">
                <h1 className="text-3xl font-bold mb-6 text-tree">
                    FOCCA ORM Documentation for SQL Server
                </h1>

                <h2 className="text-2xl font-semibold mt-10 mb-4 text-gray-800">
                    To use SqlServer in Focca Library, follow the steps below:
                </h2>
                ...
                <ul className="mb-6 text-gray-700 leading-relaxed">
                    ...
                    <li>mssql package installed</li>
                </ul>
                <Code
                    tabs={[{ label: "NPM", code: "npm install mssql" }, { label: "YARN", code: "yarn add mssql" }]}
                />
  ...
  "connections": {
    "sqlserver": {
      ...
      "database": "your_database"
                ...
                <Code
                    tabs={[{ label: "Bash", code: "npx focca config:database sqlserver" }]}
                />
                <p className="mb-6 text-gray-700 leading-relaxed">
                    This will generate a <code>focca.config.json</code> file with the default settings for SQL Server.
                </p>
                ...
                <p className="mb-6 text-gray-700 leading-relaxed">
                    To connect to the SQL Server database, you can use the <code>Database</code> class from FOCCA. The default connection will be the one defined in the configuration file.
                </p>
                <Code
                    code={`import { Database } from 'focca';

async function initialize() {
  await Database.getConnection('sqlserver');
  console.log('Connection to SQL Server established successfully!');
}
  ...
  async run() {
    await this.insert([
      ...
      { field1: 'value3', field2: 'value4' },
                ...
                <ul className="mb-6 text-gray-700 leading-relaxed">
                    <li>Ensure that SQL Server is running and accessible.</li>
                ...
                <div className="flex">
                    ...
                    <Link to="/docs/database/mongodb" className="text-[#1ED9A4]">Focus Mongodb</Link>
