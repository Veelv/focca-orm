...
const MySQLPage = () => {
    return (
        <DocumentationLayout title="FOCCA ORM Documentation for MySQL">
            <div className="prose prose-green max-w-none">
                <h1 className="text-3xl font-bold mb-6 text-tree">
                    FOCCA ORM Documentation for MySQL
                </h1>

                <h2 className="text-2xl font-semibold mt-10 mb-4 text-gray-800">
                    To use MySQL in Focca Library, follow the steps below:
                </h2>
                ...
                <ul className="mb-6 text-gray-700 leading-relaxed">
                    ...
                    <li>MySQL running</li>
                    <li>mysql2 package installed</li>
                </ul>
                <Code
                    tabs={[{ label: "NPM", code: "npm install mysql2" }]}
                />
  ...
  "connections": {
    "mysql": {
      ...
      "database": "your_database_name"
                ...
                />
                <p className="mb-6 text-gray-700 leading-relaxed">
                    This will generate a <code>focca.config.json</code> file with the default settings for MySQL.
                </p>
                ...
                <p className="mb-6 text-gray-700 leading-relaxed">
                    To connect to the MySQL database, you can use the <code>Database</code> class from FOCCA. The default connection will be the one defined in the configuration file.
                </p>
                <Code
                    code={`import { Database } from 'focca';

async function initialize() {
  await Database.getConnection('mysql');
  ...
  async run() {
    await this.insert([
      ...
      { field1: 'value3', field2: 'value4' },
                ...
                <ul className="mb-6 text-gray-700 leading-relaxed">
                    <li>Ensure that MySQL is running and accessible.</li>
